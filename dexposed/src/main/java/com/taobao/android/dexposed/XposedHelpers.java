...
//	}
    ...
    public static Method findMethodExact(ClassLoader application, String className, String methodName, Object... parameterTypes) {
        return findMethodExact(application, findClass(className, application), methodName, parameterTypes);
    }
